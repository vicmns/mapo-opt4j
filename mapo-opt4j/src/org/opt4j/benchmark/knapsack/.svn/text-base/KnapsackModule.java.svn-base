...
/**
 * The multiobjective 0/1 ILP knapsack problem. Either one of the nine benchmark
 ...
 * 
 * @see "E. Zitzler and L. Thiele: Multiobjective evolutionary algorithms: A
...
public class KnapsackModule extends ProblemModule {
	...
	protected void config() {
		...
		case BITSTRING:
			bindProblem(KnapsackBinaryCreatorDecoder.class, KnapsackBinaryCreatorDecoder.class, KnapsackEvaluator.class);
			break;
		case SAT:
			bindProblem(KnapsackSATCreatorDecoder.class, KnapsackSATCreatorDecoder.class, KnapsackEvaluator.class);
			break;
		}
	}
